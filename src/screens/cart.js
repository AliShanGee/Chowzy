        ...
        <div style={{ position: 'relative', minHeight: '100vh', paddingTop: '20px' }}>
            ...
            {showSuccess ? (
                ...
                <motion.div
                    ...
                    className={`m-5 w-100 text-center pt-5 d-flex flex-column align-items-center ${theme === 'dark' ? 'text-white' : 'text-dark'}`}
                >
                    <div style={{ width: '300px', height: '300px' }}>
                        <Lottie animationData={emptyCartAnimation} loop={true} />
                    </div>
                    <h2 className="mt-4 fw-bold">Your cart is feeling lonely</h2>
                    <p className="opacity-75 mb-4">Explore our delicious menu and add something tasty!</p>
                    <button
                        className="btn btn-success px-4 py-2 rounded-pill fs-5 shadow-sm"
                        onClick={() => navigate("/")}
                    >
                        Browse Menu
                    </button>
