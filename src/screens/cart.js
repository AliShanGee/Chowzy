...
import emptyCartAnimation from "../animations/shopping cart.json";
            ...
            {showSuccess ? (
                ...
                <div className='container m-auto mt-5 text-center'>
                    <div className='d-flex flex-column align-items-center justify-content-center pt-5'>
                        ...
                        <h2 className={`mt-4 mb-3 ${theme === 'dark' ? 'text-white' : 'text-dark'}`} style={{ fontWeight: '600' }}>
                            Your cart is empty
                        </h2>
                        <p className={`${theme === 'dark' ? 'text-white-50' : 'text-muted'} mb-4 fs-5`}>
                ...
                <div className='container m-auto mt-5 table-responsive' >
                    <table className={`table table-hover ${theme === 'dark' ? 'table-dark' : ''}`}>
                      <thead className='text-success fs-4'>
                        ...
                        <tbody className={theme === 'dark' ? 'text-white' : 'text-dark'}>
                            {data.map((food, index) => (
                    ...
                    <div className="mt-4 p-4 rounded shadow-lg text-center" style={{ background: theme === 'dark' ? 'rgba(0,0,0,0.3)' : 'rgba(0,0,0,0.03)', border: `1px solid ${theme === 'dark' ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.1)'}` }}>
