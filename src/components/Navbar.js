          ...
          <Navbar.Collapse id="navbarScroll">
            ...
            {(!localStorage.getItem("authToken")) ?
              ...
              <div className='d-flex align-items-center'>
                ...
                <button
                  type="button"
                  style={{ cursor: 'pointer', width: "100px", height: "58px", overflow: "hidden", display: "flex", alignItems: "center", marginRight: "10px", border: 'none', background: 'transparent', padding: 0 }}
