    ...
    return (
        <div style={{ position: 'relative', minHeight: '100vh', paddingTop: '20px' }}>
            ...
            {showSuccess ? (
                ...
                <div className='m-5 w-100 text-center fs-3 pt-5 d-flex flex-column align-items-center justify-content-center'>
                    <Lottie animationData={shoppingCartAnimation} style={{ height: 300, width: 300 }} />
                    <p className={theme === 'dark' ? 'text-white' : 'text-dark'}>The Cart is Empty!</p>
                    <button
                        className="btn btn-success px-4 py-2 mt-3 fs-5 rounded-pill shadow"
                        onClick={() => navigate("/")}
                    >
                        Browse Foods
                    </button>
