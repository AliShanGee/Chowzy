                        ...
                        <BootstrapCard.Text className="mb-3" style={{ 
                            ...
                            {!expanded && foodItem.description && foodItem.description.length > 60 && (
                                <button
                                    ...
                                    style={{ color: "#28a745", cursor: "pointer", fontWeight: "bold", background: "transparent", border: "none", padding: 0 }}
                                >
                                    ...
                                </button>
                            )}
                            {expanded && (
                                <button
                                    ...
                                    style={{ color: "#28a745", cursor: "pointer", fontWeight: "bold", marginLeft: "5px", fontSize: "0.75rem", background: "transparent", border: "none", padding: 0 }}
                                >
                                    (less)
                                </button>
                            )}
