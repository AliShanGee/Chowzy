                        ...
                        <BootstrapCard.Text className="mb-3" style={{ 
                            ...
                            {!expanded && foodItem.description && foodItem.description.length > 60 && (
                                <button
                                    ...
                                    style={{ color: "#28a745", backgroundColor: 'transparent', border: 'none', padding: 0, fontWeight: "bold", cursor: "pointer" }}
                                    aria-expanded="false"
                            ...
                            {expanded && (
                                <button
                                    ...
                                    style={{ color: "#28a745", backgroundColor: 'transparent', border: 'none', padding: 0, fontWeight: "bold", marginLeft: "5px", fontSize: "0.75rem", cursor: "pointer" }}
                                    aria-expanded="true"
