...
export default function Home() {
  ...
  // Performance: Memoize categories to avoid re-calculating on every render
  ...
  // Performance: Pre-group and deduplicate items in O(N) instead of nested loops in render
