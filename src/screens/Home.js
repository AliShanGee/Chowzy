...
export default function Home() {
  ...
  // ⚡ Optimization: Memoize unique categories to avoid O(N) filter on every render
  ...
  // ⚡ Optimization: Pre-group and deduplicate items by category to avoid nested O(N^2) in render loop
            ...
            return (
              <>
                {currentCategories.map((data) => {
                  const itemsInCategory = groupedItems[data.CategoryName] || [];
