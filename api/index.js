...
// Serve static files from uploads directory with absolute path (guarded for Node environment)
if (isNode) {
...
// Connect to MongoDB and Redis then start server in Node environment
if (isNode) {
    mongoDB().then(() => {
