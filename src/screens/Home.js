...
export default function Home() {
  ...
  // Performance Optimization: Memoize unique categories and grouped items to avoid O(N^2) work in render
        ...
        {uniqueCategories.length > 0 ? (
          <>
            {currentCategories.map((category) => {
              const categoryItems = groupedItems.get(category.CategoryName) || [];
