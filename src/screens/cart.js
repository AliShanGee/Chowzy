    ...
    return (
        <div style={{ position: 'relative', minHeight: '100vh', paddingTop: '20px' }}>
            ...
            {showSuccess ? (
                ...
                <div className={`m-5 w-100 text-center pt-5 ${theme === 'dark' ? 'text-white' : 'text-dark'}`}>
                    <Lottie animationData={shoppingCartAnimation} style={{ height: 250, width: 250, margin: 'auto' }} />
                    <h2 className="mt-4 fw-bold">Your Cart is Empty</h2>
                    <p className="opacity-75">Looks like you haven't added anything yet.</p>
                    <button
                ...
                <div className='container m-auto mt-5 table-responsive' >
                    ...
                    <div className="mt-4 p-4 rounded shadow-lg text-center" style={{ background: theme === 'dark' ? 'rgba(0,0,0,0.3)' : 'rgba(255,255,255,0.9)', border: `1px solid ${theme === 'dark' ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.1)'}` }}>
                        <h2 className={`fs-2 mb-4 ${theme === 'dark' ? 'text-white' : 'text-dark'}`}>Total Price: {totalPrice}/-</h2>
                        <button 
                            className='btn btn-success px-5 py-3 fs-5 shadow-sm'
